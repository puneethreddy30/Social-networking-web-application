...
<html>
<br><br><br><br>
<h1 align="center">Activity-Study. Post what you wanna play and find a mate.</h1>

<form  action="PostStudy" method="get">
<table align="center">
<tr><td><h2>I want to study<input type="hidden" name="study" value="study"> <input type="text" name="maker" value="enter course name here"></h2></td></tr>
