...
<html>
<br><br><br><br>
<h1 align="center">Activity-Play. Post what you wanna play and find a mate.</h1>

<form  action="PostPlay" method="get">
<table align="center">
<tr><td><h2>I want to play <input type="text" name="maker" value="enter sport name here"></h2></td></tr>
